...
window.addEventListener("resize", function () {
  if (window.innerWidth > 768) {
    const projectBtnsDesktop = document.querySelectorAll(
      "#portfolio-card #see-project"
    );
    for (let i in projectBtnsDesktop) {
      projectBtnsDesktop[i].addEventListener("click", function desktopPop() {
        const projectsArr = [
          {
            projectName: "Tonic",
            projectDescription:
            ...
            Technology: ["HTML", "CSS", "JavaScript"],
            linkToLive:
              "https://zafron047.github.io/Portfolio_Cohort-20_Mod-1/",
            linkToSource:
              "https://github.com/Zafron047/Portfolio_Cohort-20_Mod-1",
          },
          {
            projectName: "Tonic",
            projectDescription:
        ...
        <div class="d-card">
          <div class="D-Pop-Header">
            ...
            <a><button class="popup-close" onclick="removeNewDiv">X</button></a>
          </div>
